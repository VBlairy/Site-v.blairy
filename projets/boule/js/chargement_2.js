...
tl.to('.txt5', {display: 'inline', duration: 0.5});
tl.to('.txt6', {display: 'inline', duration: 2});
tl.to('.txt7', {display: 'inline', duration: 0.5});
tl.to('.txt8', {display: 'inline', duration: 0.5});
tl.to('.txt9', {display: 'inline', duration: 3});
tl.to('.txt10', {display: 'inline', duration: 0.5});
tl.to('.txt11', {display: 'inline', duration: 0.5});
...
tl.to('.txt40>.dot', {display: 'inline-block', duration: .2, stagger: 0.02});
tl.to('body>*,body>*>span', {display: 'none'});

tl.to('.txt50,.blink', {display: 'inline', duration: 5, delay: 3});
tl.to('body>*,body>*>span', {display: 'none'});
